      ...
      return (
        <div className="row px-xl-5" >
            <div className="col-lg-5 pb-5 text-center loading">
                <img  style={{ maxWidth: 400, height: 400, width: "100%" }} 
            ...
            <div className="col-lg-7 pb-5 loading">
                ...
                <div className="d-flex align-items-center mb-4 pt-2">
                    <button className="btn btn-primary px-3 mr-3" 
    ...
    return (
        ...
        <div className="container-fluid bg-secondary mb-5">
          <div
            ...
            style={{ minHeight: 300 }}
          >
            <h1 className="font-weight-semi-bold text-uppercase mb-3">PRODUCT DETAIL</h1>
            <div className="d-inline-flex">
              <p className="m-0">
                <Link to="/">Home</Link>
              </p>
